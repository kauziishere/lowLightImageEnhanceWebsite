import numpy as np
import keras, os, pickle, scipy, rawpy, imageio
#from model import *
...
def pre_process(filename):
	...
	input_raw = raw.postprocess(use_camera_wb = True, half_size = False, no_auto_bright = True, output_bps = 8)
	imageio.imsave("./static/in.png", input_raw)
